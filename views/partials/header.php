        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 additional-nav">
                <ul class="list-unstyled list-inline pull-right">
                    <li><a href="javascript:void(0);" onclick="$('#login-modal').modal('show');">Log In</a></li>
                    <li><a href="<?= Yii::$app->urlManager->createUrl('registration/signup') ?>">Registration</a></li>
                </ul>
            </div>
            <!-- END TOP BAR MENU -->
        </div>
...
<div class="header">
    <div class="container">
        <a class="site-logo" href="index.html"><img src="<?= $this->context->getSiteLogoImg('logo-corp-red.png') ?>" alt="<?php echo $this->context->getProjectName()?>"></a>
