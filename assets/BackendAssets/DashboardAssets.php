...
//        ============== custom css files ===========
    ...
    public $js = [
        ...
        'themes/global/plugins/flot-charts/jquery.flot.js',
        'themes/global/plugins/flot-charts/jquery.flot.resize.js',
        'themes/global/plugins/flot-charts/jquery.flot.pie.js',
        'themes/global/plugins/flot-charts/jquery.flot.categories.js',
        'themes/global/plugins/flot-charts/jquery.flot.time.js',
        'themes/global/plugins/jquery-sparkline/jquery.sparkline.js',
        'themes/backend/assets/js/admin.js',        
        'themes/backend/assets/js/pages/index.js',        
